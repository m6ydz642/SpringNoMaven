...
<%-- 			<li class="nav-item"><a class="nav-link" href="/virutal?virutal_name=${virutal_name.virutal_name}">${virutal_name.virutal_name}</a> --%>
...
<%-- </c:forEach> --%>
			...
			<li class="nav-item dropdown"><a
				...
				data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">가상게시판</a>
					...
					<c:forEach var="virutal_name" items="${applicationScope.num4 }">
						<a class="dropdown-item"
							href="/virutal?virutal_name=${virutal_name.virutal_name}">${virutal_name.virutal_name}</a>
					</c:forEach>
				</div>
		...
		<div class="collapse navbar-collapse" id="menu">
			<ul class="navbar-nav mr-auto">
				...
				<c:if test="${loginid ne null}">
					...
					<li class="nav-item"><a class="nav-link">${loginid} 님
							반갑습니다</a></li>

					<li class="nav-item"><a class="nav-link">유저등급 :
							${logintest.auth} </a></li>
				</c:if>
